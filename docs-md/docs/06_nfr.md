...
- **Controls:** Sticky routing by Mcp‑Session‑Id; **PDB** to prevent mass eviction; ingress **no buffering** for SSE.
...
- **Target:** SBOM generated per build; no known **High** vulnerabilities admitted.
