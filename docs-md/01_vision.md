...
3.  **SP‑only DAL:** SqlCommand(CommandType.StoredProcedure);
...
- **Sprint 3 — CI/CD & Evidence:** CodeQL, Dependency Review, Secret
...
1.  Deployment is containerized with ingress that supports **SSE** and
    streaming responses.
